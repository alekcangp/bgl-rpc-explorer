...
module.exports = {
  ...
  utxoSetCheckpointsByNetwork: {
    main: {
      height: 702329,
      bestblock:
        "00000000000000000005d323e8b476eac408e88002591b5ed7381ec9baaf2d13",
      transactions: 45854214,
      txouts: 75356871,
      bogosize: 5640223435,
      hash_serialized_2:
        "727879e512dde3c87ec4b3b4185d8212506a5eee517694a34785c0a63a7d78b9",
  ...
  testData: {
    txDisplayTestList: {
      "634b57cf0673c50b98560dbdf48d0a8633303b5d9162175e08b304df159c259e": {
        blockHeight: 694670,
        blockHash:
          "0000000000000000000ba61d43854a2460b219b5281db2c731ae03a4347eaf43"
      },
      ...
      "8f7f13d6b56ea9013f13d298bc0e9e9f4f9825f3e7fd96083a564b10b01025d9": {
        blockHeight: 694521,
        blockHash:
          "00000000000000000009974b5f6011d7ec8af460dafcc668c7ede4324896b9ca"
      },
      ...
      "143a3d7e7599557f9d63e7f224f34d33e9251b2c23c38f95631b3a54de53f024": {
        blockHeight: 306204,
        blockHash:
          "000000000000000038dea6f503ed3593b1495e135d9ed646c2ebb97a1ff35bd7"
      },
      ...
      "29a3efd3ef04f9153d47a990bd7b048a4b2d213daaa5fb8ed670fb85f13bdbcf": {
        blockHeight: 153509,
        blockHash:
          "00000000000000fb62bbadc0a9dcda556925b2d0c1ad8634253ac2e83ab8382f"
      },
      ...
      b53e3bc5edbb41b34a963ecf67eb045266cf841cab73a780940ce6845377f141: {
        blockHeight: 608548,
        blockHash:
          "00000000000000000009cf4a72b39c634586e6e328365f0d7293964111148094"
      }
    }
  },
      ...
      if (responseBody.bpi) {
        ...
        for (var i = 0; i < exchangedCurrencies.length; i++) {
          if (responseBody.bpi[exchangedCurrencies[i]]) {
            exchangeRates[exchangedCurrencies[i].toLowerCase()] =
              responseBody.bpi[exchangedCurrencies[i]].rate_float;
          }
        }
